...
<?php
 if(isset($_POST['submit'])) 
 {
    ...
    echo "<div style='text-align:left; padding-left:35%;'><span style='color: white;'/><p>Your Name: &nbsp;"  .$name. "</span> </p>";
    echo "<span style='color: white;'/><p>Email Address: &nbsp;"  .$email. "</span> </p>";
    echo "<span style='color: white;'/><p>Address: &nbsp;"  .$address. "</span> </p>";
    echo "<span style='color: white;'/><p>City: &nbsp;"  .$city. "</span> </p>";
    echo "<span style='color: white;'/><p>Phone Number: &nbsp;"  .$number. "</span> </p>";
    echo "<span style='color: white;'/><p>Message: &nbsp;"  .$message. "</span> </p></div>";
     

    //validation of all above fields
    if(!empty($name) || !empty($email) || !empty($address) || !empty($city) || !empty($number))
    {
        //Mail send logic
        $to       = "digitalvrgamer@gmail.com";
        $subject  = 'Contact Us';
            
        $headers  = 'From: mdzakirullah42@gmail.com' . "\r\n" . 'X-Mailer: PHP/' . phpversion();
